...
export default function EditTravelTypePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch(`/api/admin/travel-types/${id}`, { credentials: 'include' });
  ...
  return (
    <div style={{ maxWidth: 720, margin: '24px auto', padding: 24 }}>
      <h1>Modifier le type de voyage</h1>
