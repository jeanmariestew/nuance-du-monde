...
export default function OfferCard({ offer }: Props) {
  ...
  const duration = offer.duration_days ? `${offer.duration_days} jours et ${offer.duration_nights} nuits` : "";
  const price = offer.price_from?.toLocaleString('fr-FR') || "";
  const currency = offer.price_currency || "$";
  const imageUrl = offer.image_main || offer.image_url || "/images/default-destination.jpg";
          ...
          <div className="p-6 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-start gap-3 mb-4">
                <div className="flex-shrink-0 mt-1">
                  <img src="/images/moving.map.png" alt="" className="w-5 h-5 text-gray-600" />
            ...
            <div className="border-2 border-blue-300 rounded-xl p-4 bg-blue-50/30">
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-2xl font-bold text-yellow-600">{currency}</span>
